...
<a href="http://www.projectworlds.in/online-examination"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="C:\xampp\htdocs\online-examination-systen-in-php-master\online-examination-systen-in-php-master\image\DSC_0306.jpg" width=100 height=100 alt="Uttam Kumar Chauhan" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Uttam Kumar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9572519814</h4>
		<h4 style="font-family:'typo' ">kumae123@gmail.com</h4>
		<h4 style="font-family:'typo' ">Cimage Profssional College</h4></div></div>
		</p>
      </div>
